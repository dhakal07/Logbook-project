...
* URL: http://0.0.0.0:8000/
  ...
  * Attack: ``
  * Evidence: `admin`
  * Other Info: `The following pattern was used: \bADMIN\b and was detected in the element starting with: "<script>
        // Assuming we have some way of identifying the user's role (e.g., session or JWT token)
        const userRole", see evidence field for the suspicious comment/snippet.`
